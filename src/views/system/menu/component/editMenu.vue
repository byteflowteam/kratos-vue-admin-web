<template>
  <div class="system-menu-container">
    <el-dialog v-model="isShowDialog" width="769px" center>
      <template #header>
        <div style="font-size: large" v-drag="[
        ...
        <el-row :gutter="35">
          <el-col :span="24">
            <el-form-item label="上级菜单" prop="parentId">
              <el-cascader v-model="ruleForm.parentId" :options="menuOptions" class="w100" :props="{
                label: 'menuName',
                value: 'menuId',
                checkStrictly: true,
                emitPath: false,
          ...
          <el-col :span="24">
            <el-form-item label="菜单类型" prop="menuType">
              <el-radio-group v-model="ruleForm.menuType">
                <el-radio v-for="dict in menuTypeOptions" :key="dict.dictValue" :label="dict.dictValue">{{
                  dict.dictLabel }}
                </el-radio>
              </el-radio-group>
            </el-form-item>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
            <el-form-item label="菜单排序" prop="sort">
              <el-input-number v-model="ruleForm.sort" placeholder="菜单排序" clearable></el-input-number>
            </el-form-item>
          </el-col>
            ...
            <el-row :gutter="8">
              <el-col :span="22">
                <el-form-item label="权限标识" prop="permission">
                  <el-input v-model="ruleForm.permission" placeholder="路由权限标识" clearable
                    :disabled="ruleForm.menuType == 'M' ? true : false"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="2">
            ...
            <el-row :gutter="8">
              <el-col :span="22">
                <el-form-item label="路由地址">
                  <el-input v-model="ruleForm.path" placeholder="请输入路由地址" clearable></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="2">
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" v-if="ruleForm.menuType != 'F'">
            <el-form-item label="是否隐藏">
              <el-radio-group v-model="ruleForm.isHide">
                <el-radio v-for="dict in isHideOptions" :key="parseInt(dict.dictValue)"
                  :label="parseInt(dict.dictValue)">{{ dict.dictLabel }}
                </el-radio>
              </el-radio-group>
            </el-form-item>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" v-if="ruleForm.menuType != 'F'">
            <el-form-item label="是否缓存">
              <el-radio-group v-model="ruleForm.isKeepAlive">
                <el-radio v-for="dict in yesOrNoOptions" :key="parseInt(dict.dictValue)"
                  :label="parseInt(dict.dictValue)">{{ dict.dictLabel }}
                </el-radio>
              </el-radio-group>
            </el-form-item>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" v-if="ruleForm.menuType != 'F'">
            <el-form-item label="链接地址">
              <el-input v-model="ruleForm.isLink" placeholder="外链/内嵌时链接地址（http:xxx.com）" :clear="clear" clearable>
              </el-input>
            </el-form-item>
          </el-col>
  ...
  setup() {
    ...
    const openDialog = (row: any) => {
      ...
      proxy.getDicts("sys_num_yes_no").then((response: any) => {
        state.yesOrNoOptions = response.data?.list;
      });
      // 查询菜单下拉树结构
