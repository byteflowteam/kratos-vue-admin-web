      ...
      <el-form :model="queryParams" ref="queryForm" :inline="true">
        <el-row>
          <el-form-item label="标签" prop="dictName">
            <el-input placeholder="标签查询" clearable @keyup.enter="handleQuery" v-model="queryParams.dictLabel" />
          </el-form-item>
          ...
          <el-form-item>
            ...
            <el-button @click="resetQuery">
              <SvgIcon name="elementRefresh" />重置
            </el-button>
      ...
      <el-table v-loading="loading" :data="tableData">
        ...
        <el-table-column label="状态" align="center" prop="status">
          <template #default="scope">
            <el-tag :type="scope.row.status === '1' ? 'danger' : 'success'" disable-transitions>{{ scope.row.status ===
              '1' ? '停用' : '正常' }}</el-tag>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" align="center" width="150" class-name="medium-padding fixed-width">
          <template #default="scope">
            <el-popover placement="left">
              ...
              <div>
                <el-button text type="primary" v-auth="'system:dictD:edit'" @click="onOpenEditModule(scope.row)">
                  <SvgIcon name="elementEdit" />修改
                </el-button>
              </div>
              <div>
                <el-button text type="primary" v-auth="'system:dictD:delete'" @click="onTabelRowDel(scope.row)">
