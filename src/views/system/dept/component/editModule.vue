        ...
        <el-row :gutter="30">
          <el-col :span="24">
            <el-form-item label="上级部门" prop="parentId">
              <el-cascader v-model="state.ruleForm.parentId" :options="state.deptOptions" class="w100" :props="{
                value: 'deptId',
                label: 'deptName',
                checkStrictly: true,
                emitPath: false,
              }" clearable placeholder="选择上级部门" :show-all-levels="false"></el-cascader>
            </el-form-item>
          </el-col>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
            <el-form-item label="部门排序" prop="sort">
              <el-input-number v-model="state.ruleForm.sort" placeholder="部门排序" clearable controls-position="right"
...
const openDialog = (row: any) => {
  ...
  treeselect().then((response: any) => {
    ...
    dept.children = response.data?.data
